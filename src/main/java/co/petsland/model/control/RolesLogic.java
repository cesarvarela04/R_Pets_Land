    ...
    */
    ...
    public void saveRoles(Roles entity) throws Exception {
        try {
            ...
            if (entity.getRolEstado() == null) {
                throw new ZMessManager().new EmptyFieldException("rolEstado");
            }

            if ((entity.getRolEstado() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getRolEstado(), 1) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "rolEstado");
            }

            if (entity.getRolFechaCrea() == null) {
                throw new ZMessManager().new EmptyFieldException("rolFechaCrea");
            }
            ...
            if ((entity.getRolNombre() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getRolNombre(), 150) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "rolNombre");
            }

            if (entity.getRolUsuCrea() == null) {
                throw new ZMessManager().new EmptyFieldException("rolUsuCrea");
            }

            if ((entity.getRolUsuCrea() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getRolUsuCrea(), 150) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "rolUsuCrea");
            }

            if ((entity.getRolUsuModifica() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getRolUsuModifica(), 150) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "rolUsuModifica");
            }

            if (getRoles(entity.getRolCodigo()) != null) {
    ...
    public void deleteRoles(Roles entity) throws Exception {
        ...
        try {
            usuarioses = usuariosDAO.findByProperty("roles.rolCodigo",
                    entity.getRolCodigo());
    ...
    public List<RolesDTO> getDataRoles() throws Exception {
        try {
            ...
            for (Roles rolesTmp : roles) {
                ...
                rolesDTO2.setRolCodigo(rolesTmp.getRolCodigo());
                rolesDTO2.setRolEstado((rolesTmp.getRolEstado() != null)
                    ? rolesTmp.getRolEstado() : null);
                rolesDTO2.setRolFechaCrea(rolesTmp.getRolFechaCrea());
                rolesDTO2.setRolFechaModifica(rolesTmp.getRolFechaModifica());
                rolesDTO2.setRolNombre((rolesTmp.getRolNombre() != null)
                    ? rolesTmp.getRolNombre() : null);
                rolesDTO2.setRolUsuCrea((rolesTmp.getRolUsuCrea() != null)
                    ? rolesTmp.getRolUsuCrea() : null);
                rolesDTO2.setRolUsuModifica((rolesTmp.getRolUsuModifica() != null)
                    ? rolesTmp.getRolUsuModifica() : null);
    ...
    public Roles getRoles(Long rolCodigo) throws Exception {
        ...
        try {
            entity = rolesDAO.findById(rolCodigo);
        } catch (Exception e) {
